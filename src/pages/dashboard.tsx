        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle className="text-medical-dark">Coding Cheat Sheet</CardTitle>
                <CardDescription>
                  Quick reference guide for billing codes
                </CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-center py-6">
            ...
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle className="text-medical-dark">RVU Calculator</CardTitle>
                <CardDescription>
                  Look up codes and calculate payments
                </CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-center py-6">
                <div className="flex flex-col items-center gap-2">
              ...
              <CardFooter>
                <Button 
                  className={`w-full ${userRole === 'paid' 
                    ? "bg-medical-blue hover:bg-medical-blue/90 text-white" 
                    : "bg-gray-100 border border-gray-200 text-gray-500"}`}
                  onClick={() => navigate('/rvu-lookup')}
                  variant={userRole !== 'paid' ? 'outline' : 'default'}
                  disabled={userRole !== 'paid'}
                >
                  {userRole === 'paid' ? (
                    'Access RVU Calculator'
                  ) : (
                    <>
                      <Lock className="mr-2 h-4 w-4" />
                      Upgrade to Access
            ...
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle className="text-medical-dark">Patient Examples</CardTitle>
                <CardDescription>
                  Real-world billing scenarios with codes
                </CardDescription>
              </CardHeader>
              <CardContent className="flex items-center justify-center py-6">
                <div className="flex flex-col items-center gap-2">
              ...
              <CardFooter>
                <Button 
                  className={`w-full ${userRole === 'paid' 
                    ? "bg-medical-blue hover:bg-medical-blue/90 text-white" 
                    : "bg-gray-100 border border-gray-200 text-gray-500"}`}
                  onClick={() => navigate('/patient-examples')}
                  variant={userRole !== 'paid' ? 'outline' : 'default'}
                  disabled={userRole !== 'paid'}
                >
                  {userRole === 'paid' ? (
                    'View Patient Examples'
                  ) : (
                    <>
                      <Lock className="mr-2 h-4 w-4" />
                      Upgrade to Access
